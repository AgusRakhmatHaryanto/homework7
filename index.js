// soal 1 menghitung luas, Keliling pada Persegi dan Persegi Panjang
...
console.log("\n" + "Soal 1" + "\n");
console.log("\n" + "Luas Persegi adalah :", +hitung.lp(sisi) + "\n");
console.log("Keliling Persegi adalah :", +hitung.kp(sisi) + "\n");
console.log("Luas Persegi Panjang adalah :", +hitung.lpp(p, l) + "\n");
console.log("Keliling Persegi Panjang adalah :", +hitung.kpp(p, l) + "\n");

// soal 2 menulis file dari sample ke log.txt
console.log("\n" + "Soal 2" + "\n");
fs.writeFile("log.txt", data, (err) => {
  if (err) console.log(err);
  console.log("Data berhasil anda tulis!");
});
